...
```
The maximum `mean` number of steps taken is `r stepsmax` and occurs at the `r interval` time interval
...
```
The number of `missingvalues` is `r missingvalues`
